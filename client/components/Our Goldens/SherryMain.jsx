        ...
        <Container>
          <Row className='row'>
            <Col lg={6} className='leftCol'>
              <h2 className='bodyTitle'>Sherry</h2>
            ...
            <Col>
              <div className='tableDiv'>
                <Table bordered responsive="sm">
                  <thead>
                    <tr>
                      <th colSpan='3' className='tableHead'>Pedigree of CH Golden Light at Salhouse CDX (Sherry)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <td rowSpan='4' className='parents'>Sire: CH Sandlewood Gamble-with-Gold</td>
                      <td rowSpan='2' className='grandparents'>Goldfleece Go for Gold at Sandlewood (Imp Aust)</td>
                      <td className='greatGrandparents'>Aust CH Stanroph Shared Assets (Imp UK)</td>
                    </tr>
                    <tr>
                      <td className='greatGrandparents'>Dobro Free as a Bird</td>
                    </tr>
                    <tr>
                      <td rowSpan='2' className='grandparents'>CH Sandlewood Charlies Angel</td>
                      <td className='greatGrandparents'>CH McIlroy Millennium Choir Boy at Sandlewood</td>
                    </tr>
                    <tr>
                      <td className='greatGrandparents'>CH Sandlewood Cinderella</td>
                    </tr>
                    <tr>
                      <td rowSpan='4' className='parents'>Dam: CH Salhouse Sunchaser</td>
                      <td rowSpan='2' className='grandparents'>NZ CH Santamaria The Patriot (Imp Aust)</td>
                      <td className='greatGrandparents'>Aust CH Strathraer Nordic Star</td>
                    </tr>
                    <tr>
                      <td className='greatGrandparents'>Aust CH Santamaria Anna Leise</td>
                    </tr>
                    <tr>
                      <td rowSpan='2' className='grandparents'>Sanastasia Sth&apos;n Star Chara</td>
                      <td className='greatGrandparents'>CH Seacove Southern Cross</td>
                    </tr>
                    <tr>
                      <td className='greatGrandparents'>Sanastasia Treasured Teah CDX</td>
                    </tr>
                  </tbody>
                </Table>
              </div>
