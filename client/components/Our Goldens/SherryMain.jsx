  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <Image src="images/sherry1.jpg" fluid />
        </div>
      </div>
      <div>
        <p>
      ...
      <div>
        <Table bordered size='sm' responsive="sm">
          <thead>
            <tr>
              <th colSpan='3'>Pedigree of CH Golden Light at Salhouse CDX (Sherry)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              <td rowSpan='4'>Sire: CH Sandlewood Gamble-with-Gold</td>
              <td rowSpan='2'>Goldfleece Go for Gold at Sandlewood (Imp Aust)</td>
              <td>Aust CH Stanroph Shared Assets (Imp UK)</td>
            </tr>
            <tr>
              <td>Dobro Free as a Bird</td>
            </tr>
            <tr>
              <td rowSpan='2'>CH Sandlewood Charlies Angel</td>
              <td>CH McIlroy Millennium Choir Boy at Sandlewood</td>
            </tr>
            <tr>
              <td>CH Sandlewood Cinderella</td>
            </tr>
            <tr>
              <td rowSpan='4'>Dam: CH Salhouse Sunchaser</td>
              <td rowSpan='2'>NZ CH Santamaria The Patriot (Imp Aust)</td>
              <td>Aust CH Strathraer Nordic Star</td>
            </tr>
            <tr>
              <td>Aust CH Santamaria Anna Leise</td>
            </tr>
            <tr>
              <td rowSpan='2'>Sanastasia Sth&apos;n Star Chara</td>
              <td>CH Seacove Southern Cross</td>
            </tr>
            <tr>
              <td>Sanastasia Treasured Teah CDX</td>
            </tr>
          </tbody>
        </Table>
      </div>
